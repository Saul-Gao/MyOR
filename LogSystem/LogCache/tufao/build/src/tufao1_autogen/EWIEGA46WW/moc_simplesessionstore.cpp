...
#include "../../../../src/simplesessionstore.h"
...
struct qt_meta_stringdata_Tufao__SimpleSessionStore_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Tufao__SimpleSessionStore_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tufao__SimpleSessionStore_t qt_meta_stringdata_Tufao__SimpleSessionStore = {
    {
QT_MOC_LITERAL(0, 0, 25), // "Tufao::SimpleSessionStore"
QT_MOC_LITERAL(1, 26, 7), // "onTimer"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "Tufao::SimpleSessionStore\0onTimer\0"
};
...
const QMetaObject Tufao::SimpleSessionStore::staticMetaObject = {
    { &SessionStore::staticMetaObject, qt_meta_stringdata_Tufao__SimpleSessionStore.data,
      qt_meta_data_Tufao__SimpleSessionStore,  qt_static_metacall, nullptr, nullptr}
};
...
void *Tufao::SimpleSessionStore::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tufao__SimpleSessionStore.stringdata0))
