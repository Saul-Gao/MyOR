...
struct qt_meta_stringdata_Tufao__HttpsServer_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Tufao__HttpsServer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tufao__HttpsServer_t qt_meta_stringdata_Tufao__HttpsServer = {
    {
QT_MOC_LITERAL(0, 0, 18) // "Tufao::HttpsServer"
...
const QMetaObject Tufao::HttpsServer::staticMetaObject = {
    { &HttpServer::staticMetaObject, qt_meta_stringdata_Tufao__HttpsServer.data,
      qt_meta_data_Tufao__HttpsServer,  qt_static_metacall, nullptr, nullptr}
};
...
void *Tufao::HttpsServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tufao__HttpsServer.stringdata0))
